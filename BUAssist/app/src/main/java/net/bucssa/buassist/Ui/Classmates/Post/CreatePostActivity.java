...
import net.bucssa.buassist.Bean.Request.CreatePostReq;
...
public class CreatePostActivity extends BaseActivity {
    ...
    protected void initResAndListener() {
        ...
        tvSubmit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (selectedClass != null) {
                    CreatePostReq req = new CreatePostReq(UserSingleton.USERINFO.getUid(),
                            selectedClass.getClassId(), etTitle.getText().toString(),
                            etContent.getText().toString(), UserSingleton.USERINFO.getToken());
                    Gson gson = new Gson();
