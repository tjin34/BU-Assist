...
package net.bucssa.buassist.Util.zxing.android;
...
import net.bucssa.buassist.Util.zxing.camera.CameraManager;
import net.bucssa.buassist.Util.zxing.decode.DecodeThread;
import net.bucssa.buassist.Util.zxing.view.ViewfinderResultPointCallback;
