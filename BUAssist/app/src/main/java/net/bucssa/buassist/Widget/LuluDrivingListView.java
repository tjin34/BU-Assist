 ...
 */
public class LuluDrivingListView extends ListView implements AbsListView.OnScrollListener{
    ...
    public LuluDrivingListView(Context context) {
        super(context);
        init(context);
    }

    public LuluDrivingListView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public LuluDrivingListView(Context context, AttributeSet attrs, int defStyleAttr) {
